...
public class CardTokenRequestAsyncTask extends AsyncTask<String, Void, String> {
    private CardTokenRequestListener listener;
    ...
    public CardTokenRequestAsyncTask(CardTokenRequestListener listener) {
    ...
    protected String doInBackground(String... params) {
        ...
        if (chechoutId != null) {
            return requestTokenCardStatus(chechoutId);
        }
    ...
    protected void onPostExecute(String paymentStatus) {
        if (listener != null) {
            ...
            listener.onTokenCardStatusReceived(paymentStatus);
        }
    }

    private String requestTokenCardStatus(String chechoutId) {
        if (chechoutId == null) {
            return null;
        }
